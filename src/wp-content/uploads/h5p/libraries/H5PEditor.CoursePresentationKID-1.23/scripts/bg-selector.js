H5PEditor.CoursePresentationKID.BackgroundSelector = (function ($, EventDispatcher) {

  /**
   * Create a Background Selector.
   *
   * @class H5PEditor.CoursePresentationKID.BackgroundSelector
  ...
  function BackgroundSelector($backgroundSlides, isSingleSlide) {
    ...
    var radioLabels = [
      H5PEditor.t('H5PEditor.CoursePresentationKID', 'setImageBackground', {}),
      H5PEditor.t('H5PEditor.CoursePresentationKID', 'setColorFillBackground', {})
    ];
     ...
     * @returns {H5PEditor.CoursePresentationKID.BackgroundSelector}
     */
    self.addResetButton = function (text) {
      text = text || H5PEditor.t('H5PEditor.CoursePresentationKID', 'resetToDefault');
