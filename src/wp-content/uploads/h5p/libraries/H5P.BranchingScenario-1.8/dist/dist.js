...
H5P.BranchingScenario.LibraryScreen = function () {
  ...
  */
  LibraryScreen.prototype.forceContentFinished = function (instance, library) {
    ...
    // Exceptions
    if ((library === 'H5P.CoursePresentationKID' || library === 'H5P.CoursePresentation') && instance && instance.children.length + (instance.isTask ? 1 : 0) === 1 || instance.activeSurface === true) {
  ...
  LibraryScreen.prototype.show = function () {
    ...
    if (self.libraryFinishingRequirements[self.currentLibraryId] === true && (self.hasValidVideo(library) || library.type.library.split(' ')[0] === 'H5P.CoursePresentationKID' || library.type.library.split(' ')[0] === 'H5P.CoursePresentation')) {
  ...
  LibraryScreen.prototype.showNextLibrary = function (library) {
    ...
    if (!LibraryScreen.isBranching(library)) {
      ...
      if (this.libraryFinishingRequirements[library.contentId] === true && (this.hasValidVideo(library) || library.type.library.split(' ')[0] === 'H5P.CoursePresentationKID' || library.type.library.split(' ')[0] === 'H5P.CoursePresentation')) {
        this.contentOverlays[this.currentLibraryId].hide();
        this.parent.disableNavButton();
  ...
  LibraryScreen.prototype.resize = function (e) {
    ...
    var isCP = instance && (instance.libraryInfo.machineName === 'H5P.CoursePresentationKID' || instance.libraryInfo.machineName === 'H5P.CoursePresentation');
